...
// Allow for both theme modes and CSS theme values
export type Theme = ThemeMode | string | string[] | undefined;
...
export interface UseThemeProps {
  ...
  /** Color state for Material theme */
