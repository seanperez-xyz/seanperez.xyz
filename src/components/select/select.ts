...
import { SelectValidator } from '../../labs/behaviors/validators/select-validator';
import { getActiveItem } from '../../list/internal/list-navigation-helpers';
import type {
    CloseMenuEvent
...
import type { Menu } from '../../menu/internal/menu.js';
...
} from './select-option/use-select-option';
import type { SelectOptionRecord } from './shared.js';
